...
export default function Home() {
  ...
  return (
    <div className="flex justify-center items-center">
      <div className="flex h-[450px] bg-white shadow-lg rounded-lg overflow-hidden min-w-[450px] max-w-[1050px]"> {/* Increased height */}
        <Card className="flex-1 border-r border-gray-300 min-w-[450px]">
          <CardHeader className="text-2xl mt-4 text-center">
            <CardTitle>Next JS Testing</CardTitle>
            <CardDescription>Full Stack Framework</CardDescription>
          </CardHeader>
          <CardContent>
